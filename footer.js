(function () {
  ...
  function buildFooterHtml(g) {
    ...
    return '<footer style="background:#1a0f2e; font-family:\'Montserrat\',sans-serif;">'
      ...
      + '<p data-content-key="global.footer.cta_subtext" style="color:#c4b0df; font-size:0.8rem; margin:0;">' + escapeHtml(f.cta_subtext) + '</p>'
      + '</div>'
      + '<a href="kontakt.html" data-content-key="global.footer.cta_button" style="background:linear-gradient(135deg,#462b58,#aa81c5); color:#fff; padding:14px 36px; font-size:10px; font-weight:700; text-transform:uppercase; letter-spacing:.18em; text-decoration:none; border-radius:2px; white-space:nowrap;" onmouseover="this.style.opacity=\'.85\'" onmouseout="this.style.opacity=\'1\'">' + escapeHtml(f.cta_button) + '</a>'
      + '</div>'
      + '</div>'
      ...
      + '<p data-content-key="global.footer.tagline" style="color:#c4b0df; font-size:0.8rem; line-height:1.75; margin:0 0 1.5rem;">' + taglineHtml + '</p>'
      ...
      + '<li><a href="stress.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Stressforløb (Privat)</a></li>'
      + '<li><a href="stress-erhverv.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Stressforløb (Virksomhed)</a></li>'
      + '<li><a href="glad.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">GLA:D\u00ae Træning</a></li>'
      + '<li><a href="gifted.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Høj Begavelse</a></li>'
      + '<li><a href="fysioterapi.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Fysioterapi</a></li>'
      + '<li><a href="yoga.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Yogaterapi</a></li>'
      + '<li><a href="boern.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Børnefysioterapi</a></li>'
      + '<li><a href="konsulent.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Ekstern konsulent</a></li>'
      + '</ul>'
      + '</div>'
      ...
      + '<ul style="list-style:none; margin:0; padding:0; display:flex; flex-direction:column; gap:.7rem;">'
      + '<li><a href="om.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Om mig</a></li>'
      + '<li><a href="priser.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Priser</a></li>'
      + '<li><a href="https://www.skovgaardyogaogfysioterapi.dk/cohen/" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Stresstest</a></li>'
      + '<li><a href="kontakt.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Kontakt</a></li>'
      + '<li><a href="kontakt.html" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">Book tid</a></li>'
      + '</ul>'
      + '</div>'
      ...
      + '<a data-content-key="global.contact.phone" href="tel:+45' + c.phone.replace(/\s/g, '') + '" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">' + escapeHtml(c.phone) + '</a>'
      + '</li>'
      + '<li style="display:flex; gap:.75rem; align-items:center;">'
      ...
      + '<a data-content-key="global.contact.email" href="mailto:' + escapeHtml(c.email) + '" style="color:#c4b0df; font-size:.82rem; text-decoration:none;" onmouseover="this.style.color=\'#fff\'" onmouseout="this.style.color=\'#c4b0df\'">' + escapeHtml(c.email) + '</a>'
      + '</li>'
      + '<li style="display:flex; gap:.75rem; align-items:flex-start;">'
      ...
      + '<span data-content-key="global.hours" style="color:#c4b0df; font-size:.82rem; line-height:1.65;">' + hoursHtml + '</span>'
      + '</li>'
      + '</ul>'
      + '</div>'
      + '</div>'
      ...
      + '<p data-content-key="global.footer.copyright" style="color:rgba(196,176,223,.45); font-size:.7rem; text-transform:uppercase; letter-spacing:.15em; margin:0;">' + escapeHtml(f.copyright) + '</p>'
      + '<p data-content-key="global.footer.credit" style="color:rgba(196,176,223,.35); font-size:.7rem; margin:0;">' + escapeHtml(f.credit) + '</p>'
      + '</div>'
      + '</div>'
